...
(In Germany is about 0.1 per 10.000 people,
In Japan is about 0.02 per 10.000 people)
]
...
<img src="figs/thesis_flow_chart.png" style="width: 75%" />
...
---
class: center
# Spatial distribution- forecasted crime
...
---
class: center
# Distribution of the forecasted crime
**municipalities in dark green are lagging behind**
...
# Chapter 3: BMA - crime determinants
 212 variables (original and spatially lagged). **The significant determinants of homicides are **: 

<img src="figs/bma.jpg" style="width: 65%"/>

---
class:  center
# The significant determinants are: 
<img src="figs/determinants_crime.PNG" style="width: 85%"/>
